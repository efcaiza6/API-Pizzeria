package com.efcaiza6.pizza.web.controller;

import com.efcaiza6.pizza.persistence.entity.PizzaEntity;
import com.efcaiza6.pizza.service.PizzaService;
import com.efcaiza6.pizza.service.dto.UpdatePizzaPriceDto;
...
public class PizzaController {
    ...
    public ResponseEntity<Void> updatePrice(@RequestBody UpdatePizzaPriceDto updatePizzaPriceDto) {
        if (this.pizzaService.exist(updatePizzaPriceDto.getPizzaId())) {
